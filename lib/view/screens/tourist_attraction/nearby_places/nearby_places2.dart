...
class NearbyPlaces2 extends StatefulWidget {
  NearbyPlaces2({super.key});

  @override
  State<NearbyPlaces2> createState() => _NearbyPlaces2State();
}

class _NearbyPlaces2State extends State<NearbyPlaces2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // _BuildMap(),
          GetBuilder<PlacesController>(builder: (controller) {
                ...
                builder: (BuildContext context, Set<Marker>? markers) {
                  return GoogleMap(
                    ...
                    onMapCreated: (GoogleMapController googleMapController) {
                      if (!controller.mapController2.isCompleted) {
                        controller.mapController2.complete(googleMapController);
                      }

                      controller.animateCamera2();
                    },
                  );
                });
          }),
